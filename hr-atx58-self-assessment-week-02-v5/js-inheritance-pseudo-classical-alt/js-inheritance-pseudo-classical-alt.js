...
FlyingHorse.prototype.goSomewhere = function(destination, milesToDestination) {
  ...
  var myHorse = new Horse('Oliver');
  var myFlyingHorse = new FlyingHorse('Flying Oliver', 'Blue');
  var farDestination = myFlyingHorse.goSomewhere('Austin', 50);
  var closeDestination = myFlyingHorse.goSomewhere('Austin', 5);

  console.log(myFlyingHorse, farDestination, closeDestination)